var currentSimList = ["LR", "T1", "Both"];
var currentSim = "LR";
var currentSimId = 0;
var currentSceneList = ["sample0", "sample1","sample2", "sample3"];
var currentScene = "sample0";
var currentSceneId = 0;
var currentMethodList = ["ours", "onestep"];
...
function ChangeSim(idx){
    ...
    document.getElementById("simulation_video").src = "ScoreFusion_files/ours/"+ currentSim + '_' + currentScene + '.mp4';
    // ChangeMethod(0);
}
...
function ChangeScene(idx){
    ...
    video.src = "ScoreFusion_files/ours/"+ currentSim + '_' + currentScene + '.mp4';

    container.style = "width: 50%; opacity: 0;"
    setTimeout(()=>{
        container.style = "width: 50%; opacity: 1;"
        video.load();
    }, 1000)
...
function ChangeMethod(idx){
    ...
    document.getElementById("baseline").src = "ScoreFusion_files/" + currentMethod +'/'+ currentSim +'_'+ currentScene + '.mp4';
    if(idx == 0){
